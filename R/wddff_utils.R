...
#' in subsequent functions within the SWDDFF based on the type of wavelet-
...
#'
#' Output:
#' @param W - wavelet and scaling coefficients [N x D x J+1] (wavelet coefs in first J columns, scaling coefs in last)
#'
#'
#' Reference(s):
#'
...
waveletDecomp <- function(y,wt='at',wavelet='haar',decomp_level=1){
