...
#'
#' Output:
#' @param res - S index of average asymmetry degree [scalar]
...
#'
#' Output:
#' @param res - T index of average asymmetry degree [scalar]
...
#' This function calculates the average deviation amplitude (D) given a
#' set of predictions 'X', the target 'Y', and a confidence level of
#' 1 - alpha.
#'
#'
...
#'
#' Output:
#' @param res - average deviation amplitude [scalar]
